...
public class ListeSimple {
     ...
     * @param element l'élément à supprimer
     * @param tete la tête de la liste à traiter
    ...
    /**
     * Travail sur l'avant-dernier noeud de la liste.
    ...
    /**
     * Retourne le noeud précédent un noeud donné.
